...
disease_symptom_data = pd.read_csv("https://raw.githubusercontent.com/Vindhya01/disease_prediction/main/disease_symptom_dataset/dataset.csv")
...
# Raw URL to the CSV file
url = "https://raw.githubusercontent.com/Vindhya01/disease_prediction/main/disease_symptom_dataset/symptom_severity.csv"

# Load the data
symptom_severity_data = pd.read_csv(url)

# Extract the 'Symptom' column
...
desc = pd.read_csv("https://raw.githubusercontent.com/Vindhya01/disease_prediction/main/disease_symptom_dataset/symptom_description.csv")
...
prec = pd.read_csv("https://raw.githubusercontent.com/Vindhya01/disease_prediction/main/disease_symptom_dataset/symptom_precaution.csv")
...
# Create the Series 't' with the given symptoms set to 1
t = pd.Series([0]*222, index=x)

# Load the trained decision tree model from the URL
url = "https://raw.githubusercontent.com/Vindhya01/disease_prediction/main/decision_tree_model.pkl"
response = requests.get(url)

# Check if the request was successful
if response.status_code == 200:
    model_data = BytesIO(response.content)
    m = pickle.load(model_data)

    # Set the symptoms to 1 (indicating presence of these symptoms)
    t.loc["chest_pain"] = 1
    t.loc["phlegm"] = 1
    t.loc["runny_nose"] = 1
    t.loc["high_fever"] = 1
    ...
    # Convert the Series to a numpy array and reshape it for prediction
    t = t.to_numpy()
    print(t.shape)
    t = t.reshape(1, -1)
